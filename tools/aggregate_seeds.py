...
def main(args):
    ...
    if args.print:
        ...
        print('bAP:  {}'.format(metrics['bAP']))
        print('Mean bAP:  {0:.4f}'.format(np.mean(metrics['bAP'])))
        print('bAP50:  {}'.format(metrics['bAP50']))
        print('Mean bAP50:  {0:.4f}'.format(np.mean(metrics['bAP50'])))
        print('nAP:  {}'.format(metrics['nAP']))
        print('Mean nAP:  {0:.4f}'.format(np.mean(metrics['nAP'])))
        print('nAP50:  {}'.format(metrics['nAP50']))
        print('Mean nAP50:  {0:.4f}'.format(np.mean(metrics['nAP50'])))
        # Verbose output
        # for metric in metrics:
        #     # print(metric)
