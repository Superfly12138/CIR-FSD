...
PASCAL_VOC_ALL_CATEGORIES = {
    1: [
        'airport','basketballcourt', 'bridge', 'chimney', 'dam', 'Expressway-Service-area',
 'Expressway-toll-station', 'golffield', 'groundtrackfield','harbor', 'overpass', 'ship', 'stadium',
 'storagetank', 'vehicle',  'airplane','baseballfield','tenniscourt','trainstation','windmill',
    ],
    2: [       
        'airport','basketballcourt', 'bridge', 'chimney', 'dam', 'Expressway-Service-area',
 'Expressway-toll-station', 'golffield', 'groundtrackfield','harbor', 'overpass', 'ship', 'stadium',
...
PASCAL_VOC_NOVEL_CATEGORIES = {
    1: ['airplane','baseballfield','tenniscourt','trainstation','windmill'],
    # 1: ['baseballfield','basketballcourt','bridge','chimney','ship'],
...
#        1: [
#         'airport',  'dam', 'Expressway-Service-area',
#  'Expressway-toll-station', 'golffield', 'groundtrackfield','harbor', 'overpass', 'stadium',
#  'storagetank', 'vehicle',  'airplane','tenniscourt','trainstation','windmill',
#     ],
    2: [       
        'basketballcourt', 'bridge', 'chimney', 'dam', 'Expressway-Service-area',
  'golffield', 'overpass', 'ship', 'stadium',
 'storagetank', 'vehicle', 'baseballfield','tenniscourt','trainstation','windmill',
    ],
    3: [
       'airport','basketballcourt', 'bridge', 'chimney', 'Expressway-Service-area',
 'Expressway-toll-station',  'groundtrackfield','harbor', 'overpass', 'ship', 'stadium',
  'airplane','baseballfield','trainstation','windmill',
    ],
    4: [
       'airport','basketballcourt', 'bridge', 'chimney', 'dam',
 'Expressway-toll-station', 'golffield', 'groundtrackfield','harbor', 'ship',
 'storagetank', 'vehicle',  'airplane','baseballfield','tenniscourt',
    ],
}
